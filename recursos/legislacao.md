...
|---|---|---|
| **Regulamento (UE) 2016/679 (RGPD)** | Protecção de dados pessoais | Aplica-se directamente. Articulação com NIS2 na notificação de incidentes (ver [C.4]({% link 02-notificacao-incidentes/c4-cruzamento-rgpd.md %})). [Texto integral](https://eur-lex.europa.eu/legal-content/PT/TXT/?uri=CELEX%3A32016R0679){:target="_blank"} |
...
## Quadro Nacional de Referência para a Ciberseguranca (QNRCS)
