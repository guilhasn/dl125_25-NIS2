---
title: "A.4 Prazos, sanções e amnistia"
layout: default
...
O Capítulo VII do RJC (arts. 61.º a 81.º) estrutura as contraordenações em três níveis: **muito graves** (art. 61.º), **graves** (art. 62.º), **leves** (art. 63.º). Para autarquias (entidades públicas relevantes), os limites são significativamente inferiores aos das entidades essenciais, mas estão longe de ser triviais.

### Pessoa colectiva (a câmara como entidade)

| Grupo | Muito graves (art. 61.º) | Graves (art. 62.º) |
|---|---|---|
| **Grupo A** (≥ 250 trabalhadores) | **16.000 € a 4.000.000 €** | **10.000 € a 2.500.000 €** |
| **Grupo B** (75–249 trabalhadores) | **8.000 € a 350.000 €** | **5.000 € a 225.000 €** |

### Pessoa singular (titulares de cargos com responsabilidade)

| Categoria | Muito graves | Graves |
|---|---|---|
...
Para perspectivar a diferença de regime que justifica a vossa categoria como "pública relevante":

| Tipo de entidade | Muito graves (PC) — máximo |
|---|---|
| Entidade essencial | até **10.000.000 €** (ou 2 % do volume de negócios) |
| Entidade importante | até **7.000.000 €** (ou 1,4 % do volume de negócios) |
| **Pública relevante Grupo A** | **até 4.000.000 €** |
| **Pública relevante Grupo B** | **até 350.000 €** |

A diferença é considerável — mas 350.000 € não é "simbólico" para o orçamento corrente de uma câmara média.
...
- **Interdição temporária do exercício de cargos sociais ou de funções de direcção** em pessoas colectivas (no contexto autárquico, lê-se: dirigentes responsáveis).
- **Publicidade da decisão condenatória** — publicação no DR e/ou em órgão de comunicação social com expressão local.

A **proibição de contratação pública** e a **publicidade da decisão** são as duas sanções acessórias que, em termos práticos, mais penalizam politicamente um executivo municipal — bastante mais do que o valor da coima.

## Sanções pecuniárias compulsórias (art. 68.º)

Se, depois de notificada, a entidade não cumprir, o CNCS pode aplicar **sanção pecuniária compulsória**: **500 €/dia** (pessoa colectiva) ou **100 €/dia** (pessoa singular), até **30 dias**. Acumula com a coima.

## Dispensa de coimas (art. 65.º) — atenção: **não é amnistia automática**

Esta é a cláusula mais frequentemente mal interpretada na transposição portuguesa.

> «Durante os 12 meses seguintes à entrada em vigor do presente regime, o CNCS pode dispensar a aplicação de coimas previstas nos artigos 61.º e 62.º, mediante pedido fundamentado, com base na inexistência de procedimento interno de adaptação às obrigações dele decorrentes.» — paráfrase do art. 65.º do RJC

A leitura corrente — "**até Abril de 2027 não há risco de coima**" — está **errada**. O que o art. 65.º estabelece é:

1. **Janela temporal**: 12 meses após a entrada em vigor do DL → até cerca de **3 de Abril de 2027**.
2. **Coimas abrangidas**: muito graves (art. 61.º) e graves (art. 62.º). **Leves não, sanções acessórias não, sanções compulsórias não**.
3. **Procedimento**: a dispensa **requer pedido fundamentado** dirigido ao CNCS.
4. **Critério substantivo**: o pedido tem de basear-se na **inexistência de procedimento interno de adaptação** às obrigações. Lê-se na contramão: a dispensa supõe **que vocês têm um procedimento de adaptação em curso, e demonstram-no**. Se não houver evidência de plano, calendarização, esforço documentado de adaptação, o pedido é indeferido.
5. **Discricionariedade**: "o CNCS **pode** dispensar" — não é direito subjectivo. O CNCS aprecia e decide.

### Erro típico a evitar

> "Não vamos fazer nada nos próximos 12 meses, há amnistia."

**Errado**. Para que a dispensa seja concedível, **vocês têm de estar a fazer alguma coisa**. Idealmente:

- Plano de adaptação documentado, com calendário e responsáveis.
- Actas de reunião do executivo a aprovar o plano.
- Evidência de despesa: contratação de consultoria, formação (esta!), aquisição de software.
- Comunicações internas a divulgar políticas.
...
>
> Câmara com cerca de 220 trabalhadores sofreu incidente de cibersegurança em 2026. Após relatório do CNCS, a entidade invocou a dispensa do *art. 65.º RJC*, apresentando a violação como facto isolado e a câmara como vítima. O CNCS pediu evidência do processo de adaptação **em curso à data do incidente**.
>
> **Pergunta:** o CNCS vai aceitar a dispensa? Que terá a câmara de demonstrar?

<details markdown="block">
<summary><strong>Ver resposta</strong></summary>

Não automaticamente. O art. 65.º **não é amnistia** — é dispensa **discricionária** do CNCS, mediante pedido fundamentado e prova de adaptação iniciada **antes** dos factos: despacho de início, cronograma, responsável nomeado, actas de decisão, comunicações internas. Sem nada disto, a entidade não consegue demonstrar diligência e o pedido é indeferido.

Antes de qualquer incidente: aprovar plano por despacho do executivo, nomear responsável interno, calendarizar medidas, manter actas. A dispensa é **mérito demonstrado**, não declaração tardia em audição.
</details>
