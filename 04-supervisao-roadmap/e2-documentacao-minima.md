---
title: "E.2 Documentação mínima — checklist"
layout: default
...
| Peça | Forma | Onde fica | Quem mantém |
|---|---|---|---|
| ☐ **Registo no MyCiber** | Submissão na plataforma | MyCiber + cópia interna do comprovativo | Ponto de contacto |
| ☐ **Despacho de designação do ponto de contacto** | Despacho do presidente | Arquivo interno + cópia no MyCiber | Secretaria-geral |
| ☐ **Comunicação ao CNCS de RC/PCP** (apenas em dupla qualificação SMAS) | Submissão MyCiber | MyCiber | Direcção do SMAS |
...
| Peça | Forma | Quem mantém |
|---|---|---|
| ☐ **Plano de resposta a incidentes** (mesmo mínimo) | Documento interno | Informática + DPO |
| ☐ **Registo cronológico de cada incidente** (independentemente de notificado ou não) | Folha Excel ou registo digital | Informática |
| ☐ **Cópias das notificações submetidas ao CNCS** | PDF arquivado + IDs | Ponto de contacto |
| ☐ **Cópias das notificações à CNPD** (RGPD) | PDF arquivado | DPO |
| ☐ **Folha-resumo dos prazos PT vs NIS2** afixada no gabinete TIC | Papel ou digital | Informática |
...
## Continuidade, *backups*, recuperação

| Peça | Forma | Quem mantém |
|---|---|---|
| ☐ **Política de *backups*** | Documento aprovado | Informática |
| ☐ **Registo dos testes de *backup*** trimestral (B) / mensal (A) | Folha de registo datada | Informática |
| ☐ **Plano de Continuidade de Negócio (PCN)** | Documento aprovado | Gestão + Informática |
| ☐ **(A) Plano de Recuperação de Desastres (DRP)** separado | Documento aprovado | Informática |
...
| Peça | Forma | Quem mantém |
|---|---|---|
| ☐ **Plano anual de formação** ([H.PF]({% link recursos/anexo-iv-aviso-5146.md %}#h-pf)) | Folha Excel | RH + Formador interno |
| ☐ **Programa pedagógico** das sessões realizadas | Documentos arquivados | RH |
| ☐ **Registo de presenças** assinado de cada sessão | Folhas arquivadas | RH |
| ☐ **Guia de ciber-higiene** distribuído no *onboarding* | Documento padrão entregue | RH |
| ☐ **(A) Registo de campanhas de phishing simulado** (H.EC) | Relatório semestral | Informática |
...
A maior parte destas peças já existe **embrionariamente** nos exercícios A1 a A5 da formação. O Roadmap em [E.3]({% link 04-supervisao-roadmap/e3-roadmap-6-meses.md %}) traduz isto para um cronograma de **6 meses** mês-a-mês.
