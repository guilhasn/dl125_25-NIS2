...
> «As medidas de ciberseguranca a adotar pelas entidades essenciais e importantes (...) abrangem, designadamente, as seguintes áreas: a) Tratamento de incidentes (...).» — art. 27.º, n.º 1, al. a) do RJC

> «As entidades essenciais, importantes e públicas relevantes notificam qualquer incidente significativo à autoridade de ciberseguranca competente.» — art. 40.º, n.º 1 do RJC
...
|---|---|---|
| **Decisor** | Dirigente máximo do serviço ou seu substituto (presidente de câmara, vereador com pelouro, director do DIM) | Activa o plano; autoriza comunicação externa; decide envolvimento de fornecedor/peritos. |
| **Executor técnico** | Responsável de TIC ou equivalente; em câmaras pequenas, responsável funcional do sistema afectado | Contém o incidente; preserva evidência; coordena recuperação. |
...
- **CNCS** — plataforma electrónica, 24h após verificação do incidente significativo (art. 42.º, n.º 1).
...
- **Destinatários dos serviços** (munícipes, contribuintes) — art. 48.º do RJC: comunicação «sem demora injustificada» quando o incidente seja susceptível de os afectar negativamente.
...
- **Responsável de Ciberseguranca (RC)** obrigatório — art. 31.º do RJC. Pessoa singular com responsabilidades específicas, comunicada ao CNCS pela plataforma electrónica.
...
[Exercício A4 — Notificação 24h]({% link exercicios/a4-notificacao.md %}) (25 min, dentro de C.6) — cada par recebe um cartão de cenário e simula a activação do plano + preenchimento da notificação inicial. Os cartões e as instruções estão em [C.6 — Cartões de cenário]({% link 02-notificacao-incidentes/c6-cenarios-exercicio.md %}).
