...
Definida no **Cap. II do Aviso 5146/2026/2** (arts. 4.º a 19.º). É o **único canal oficial** de comunicação com a autoridade de cibersegurança para autoidentificação, registo, comunicação de RC/PCP (não aplicável a autarquias), notificação de incidentes, relatório anual e receção de notificações eletrónicas do CNCS.

Endereço: **[https://myciber.gov.pt/](https://myciber.gov.pt/){:target="_blank"}**.

**Autenticação**: Cartão de Cidadão ou Chave Móvel Digital, com perfil de utilizador associado à entidade. Para autarquias, o secretário-geral ou o presidente designam por escrito quem pode atuar em nome da entidade.
...
3. **Tipo de notificação** — inicial (24h), atualização (72h), fim de impacto (24h após cessação), relatório final (30 dias úteis), intercalar (semanal).
4. **Preenchimento do formulário** — campos derivados diretamente dos arts. 42.º a 44.º do RJC (ver [C.3]({% link 02-notificacao-incidentes/c3-conteudo-notificacao.md %})). Campos obrigatórios marcados; possibilidade de salvar rascunho e retomar.
